        ...
        <Navbar expand="sm" className='container-xxl bg-white d-flex flex-column justify-content-center align-items-center bg-white h-100'>
          <div className="nav1 w-100 d-flex justify-content-between align-items-center" >
            <Navbar.Brand className='navBrand d-flex justify-content-sm-center'>
              <Link to="/" className="text-decoration-none"><span className='fw-bold'>Jack's Garden Admin</span></Link>
            </Navbar.Brand>
            <div className="d-flex flex-row justify-content-end align-items-center">
              <List size="30px" onClick={handleShow} />
              <Offcanvas className="w-auto p-0" show={show} onHide={handleClose}>
                <Offcanvas.Header closeButton className="position-fixed"></Offcanvas.Header>
